...
function bulmascores_scripts() {
	...
	wp_enqueue_script( 'waypoints-noframework', get_template_directory_uri() . '/assets/js/noframework.waypoints.min.js', array(), null, true );
	wp_enqueue_script( 'particles', get_template_directory_uri() . '/assets/js/particles.js', array(), null, true );
	wp_enqueue_script( 'custom-scripts', get_template_directory_uri() . '/assets/js/custom_scripts.js', array(), null, true );
